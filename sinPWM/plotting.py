...
class AnimationPlot:
    ...
    def animate(self, i, dataList, ser):
        ...
        arduinoData_string = ser.readline()[:-2].decode('utf-8', 'ignore')
    ...
    def getPlotFormat(self):
        ...
        ax.set_title("Sin ware")                        # Set title of figure
...
ser = serial.Serial(portName, 115200)                       # Establish Serial object with COM port and BAUD rate to match Arduino Port/rate
